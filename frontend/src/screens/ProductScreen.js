    ...
    <section className="overflow-hidden text-gray-700 body-font">
      <div className="container px-5 py-24 mx-auto">
        <div className="flex flex-wrap mx-auto lg:w-4/5">
          <img
            alt="ecommerce"
            className="object-cover object-center w-full h-64 rounded shadow-lg lg:w-1/2 lg:h-auto"
            src={image}
          />
          <div className="w-full mt-6 lg:w-1/2 lg:pl-10 lg:py-6 lg:mt-0">
            ...
            <p className="pb-4 mb-4 leading-relaxed border-b-2 border-gray-200">
              {description}
            </p>
            <div className="flex">
              ...
              <button
                className="flex px-6 py-2 ml-auto text-white bg-indigo-500 border-0 rounded focus:outline-none hover:bg-indigo-600 disabled:opacity-30 disabled:text-gray-50"
